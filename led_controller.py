...
def ToggleLEDNormalMode(current_switch):
    if leds[current_switch] == RGB_RED:
        leds[current_switch] = RGB_OFF
    else:
        leds[current_switch] = RGB_RED

def ToggleLEDPerformanceMode(current_switch):
    if leds[current_switch] == current_color:
        leds[current_switch] = RGB_OFF
    else:
        leds[current_switch] = current_color